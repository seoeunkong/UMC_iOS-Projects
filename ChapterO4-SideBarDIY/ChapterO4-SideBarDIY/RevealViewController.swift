...
class RevealViewController: UIViewController {
    ...
    var sideVC: UIViewController? // 사이드 바 메뉴를 誰할 뷰 컨트롤러
    ...
    func setupView() {
        ...
        self.view.addSubview(vc.view) // _프론트 컨트롤러 뷰를 메인 컨트롤러 서브 뷰로 등록
        // _프론트 컨트롤러에 부모 뷰 컨트롤러가 바뀌었음을 알려준다.
        vc.didMove(toParent: self)
            
        // 4 프론트 컨트롤러의 델리게이트 변수에 참조 정보暑 넣어준다,
    ...
    func getSideView() {
        ...
        // 4一프론트 컨트롤러에 부모 뷰 컨트롤러가 바뀌었음을 알려준다.
        vc.didMove(toParent: self)
